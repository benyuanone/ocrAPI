 ...
 * </ul>
 */
public class APIByValueAction implements ComponentListinerSer {
    //
//[{"api":"api路径","sucess":"成功提示","fail":"失败提示"}]
    ...
    public void doAction(BaseWindow window, Event event, PageControlVO pgvo) {
        ...
        try {
            ...
            Map<String,Object> allMap = window.bindAll2Ppt(true);
            ResponseMessage responseMessage = JsonPostUtils.executeAPI(allMap,_params.get("api").toString());
