 ...
 */
public class DoWithOwidSer implements ComponentListinerSer {
    // [{"apiUrl":"接口路径","fail":"失败提示标签","success":"成功提示标签","confirm":"确认语句标签","closed":""}]
    @Override
    public void doAction(BaseWindow window, Event event, PageControlVO pgvo) {
        ...
        if (null == responseMessage || responseMessage.getBackCode() != 0) {
            ...
            if (!TextUtils.isEmpty(_params.get("closed")) && _params.get("closed").toString().equalsIgnoreCase("true")) {
                try {
