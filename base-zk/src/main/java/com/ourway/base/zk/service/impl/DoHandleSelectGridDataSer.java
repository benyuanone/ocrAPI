 ...
 */
public class DoHandleSelectGridDataSer implements ComponentListinerSer {
    ...
    public void doAction(BaseWindow window, Event event, PageControlVO pgvo) {
        ...
        ResponseMessage responseMessage = JsonPostUtils.executeObjAPI(grid.getSelectRowsData(), _params.get("apiUrl").toString());
