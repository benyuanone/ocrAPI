 ...
 * <p>Default {@link #getZclass}: z-css.
...
public class Chosenbox extends HtmlBasedComponent {
	...
	public String getZclass() {
		return _zclass == null ? "z-css" : _zclass;
	}
	...
	/**
	 * Returns the model associated with this css, or null if this
	 * css is not associated with any list data model.
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Sets the list model associated with this css. If a non-null model
