 ...
 */
public class BaseTextbox extends Textbox implements ComponentSer<String> {
    private String property;
    private PageControlVO pgvo;//当前控件的属性对象
    private String realVal;//实际值，为了防止取报表数据的时候防止被篡改
    @Override
...
//                    setValue(null == mess.getBean() ? "" : mess.getBean().toString());
//                }
                break;
        }
    }
