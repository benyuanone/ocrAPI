 ...
 * </pre>
 */
public class ButtonComponentDetailAction extends BaseWindow {
    protected Log info = LogFactory.getLog(ButtonComponentDetailAction.class);
