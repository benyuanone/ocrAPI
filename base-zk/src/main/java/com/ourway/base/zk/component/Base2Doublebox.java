 ...
 * </ul>
 */
public class Base2Doublebox extends Hbox implements ComponentSer<String> {
    private String property;
    private PageControlVO pgvo;//当前控件的属性对象
    private List<Object> selVals; //返回选中的值
    private BaseDoublebox db1;//时间段1
    private BaseDoublebox db2;//时间段2

    public void onCreate() {
        db1 = new BaseDoublebox();
        db1.setParent(this);
        BaseLabel label = new BaseLabel();
        label.setValue("-");
        label.setParent(this);
        db2 = new BaseDoublebox();
        db2.setParent(this);
    }
