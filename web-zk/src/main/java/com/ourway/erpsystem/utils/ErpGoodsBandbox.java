...
public class ErpGoodsBandbox extends BaseBandbox {
    ...
    public static final String API_URL = "/newErpGoodsApi/listErpGoods";
    public static final String API_OR_URL = "/newErpGoodsApi/listErpOrGoods";
    ...
    public void initHead() {
        ...
        Listheader h1 = PageUtils.createListheader(lb, "goodsId");
 ...
 //根据查询条件返回数据
    ...
    private void initList(List<Map<String, Object>> datas) {
        for (Map<String, Object> cst : datas) {
            ...
            cell.setParent(item);
            cell.setLabel(null == cst.get("goodsId") ? "" : cst.get("goodsId").toString());
            cell = new Listcell();
            cell.setParent(item);
            cell.setLabel(null == cst.get("name") ? "" : cst.get("name").toString());
            cell = new Listcell();
            cell.setParent(item);
            cell.setLabel(null == cst.get("engName") ? "" : cst.get("engName").toString());
            cell = new Listcell();
            cell.setParent(item);
            cell.setLabel(null == cst.get("otherName") ? "" : cst.get("otherName").toString());
        }
