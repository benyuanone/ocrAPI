 ...
 * yo
 */
public class ErpGuest2GoodsBandbox extends BaseBandbox {
    private static final long serialVersionUID = -7917484960028594428L;
    public static final String API_URL = "/newErpGuestApi/listErpGuest";
    public static final String API_OR_URL = "/newErpGuestApi/listErpOrGuest";
    private BaseListbox lb = new BaseListbox();// 列表
    private Bandpopup pup = new Bandpopup();
    private List<Object> lbs = new ArrayList<Object>();
    private BaseTextbox guestId = new BaseTextbox();// 查询条件
    private BaseTextbox guestName = new BaseTextbox();// 查询条件
    ...
    public void initFilterCon() {
        ...
        guestName.setParent(row);
        guestName.setWidth("200px");
    ...
    public void initHead() {
        ...
        Listheader h1 = PageUtils.createListheader(lb, "guestId");
        h1 = PageUtils.createListheader(lb, "name");
//        h1 = PageUtils.createListheader(lb, "engName");
//        h1 = PageUtils.createListheader(lb, "otherName");
 ...
 //根据查询条件返回数据
    ...
    public void queryData() {
        ...
        List<Object> arrayList = new ArrayList<Object>();
        FilterModel model = new FilterModel();
        model.setKey("guestId");
        model.setType(FilterModel.LIKE);
        arrayList.add(guestId.getText());
        model.setDatas(arrayList);
        models.add(model);
        ...
        model.setKey("name");
        model.setType(FilterModel.LIKE);
        arrayList.add(guestName.getText());
        model.setDatas(arrayList);
        models.add(model);
        List<Map<String, Object>> datas = filterFromApi(models);
        if (null != datas && datas.size() > 0)
