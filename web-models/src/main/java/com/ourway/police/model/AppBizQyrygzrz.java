 ...
 */
@Entity
@Table(name = "app_biz_qyrygzrz", schema = "public_manage", catalog = "")
public class AppBizQyrygzrz {
    private String owid;
    private String appOwid;
    private Timestamp gzkssj;
    private Timestamp gzjssj;
    private Timestamp gzdd;
    private String gwxx;
    private String gzrq;
    private String cylb;
    private String exp1;
    ...
    @Basic
    @Column(name = "GZKSSJ", nullable = true)
    public Timestamp getGzkssj() {
        return gzkssj;
    }
    ...
    @Basic
    @Column(name = "GZJSSJ", nullable = true)
    public Timestamp getGzjssj() {
        return gzjssj;
    }
    ...
    @Basic
    @Column(name = "GZDD", nullable = true)
    public Timestamp getGzdd() {
        return gzdd;
    }

    public void setGzdd(Timestamp gzdd) {
        this.gzdd = gzdd;
    }

    @Basic
    @Column(name = "GWXX", nullable = true, length = 300)
    ...
    @Basic
    @Column(name = "GZRQ", nullable = true, length = 100)
    ...
    public boolean equals(Object o) {
        ...
        AppBizQyrygzrz that = (AppBizQyrygzrz) o;
        ...
        if (gzkssj != null ? !gzkssj.equals(that.gzkssj) : that.gzkssj != null) return false;
        if (gzjssj != null ? !gzjssj.equals(that.gzjssj) : that.gzjssj != null) return false;
        if (gzdd != null ? !gzdd.equals(that.gzdd) : that.gzdd != null) return false;
        if (gwxx != null ? !gwxx.equals(that.gwxx) : that.gwxx != null) return false;
        if (gzrq != null ? !gzrq.equals(that.gzrq) : that.gzrq != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (gzkssj != null ? gzkssj.hashCode() : 0);
        result = 31 * result + (gzjssj != null ? gzjssj.hashCode() : 0);
        result = 31 * result + (gzdd != null ? gzdd.hashCode() : 0);
        result = 31 * result + (gwxx != null ? gwxx.hashCode() : 0);
        result = 31 * result + (gzrq != null ? gzrq.hashCode() : 0);
