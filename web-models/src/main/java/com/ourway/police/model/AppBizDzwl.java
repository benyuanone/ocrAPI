 ...
 */
@Entity
@Table(name = "app_biz_dzwl", schema = "public_manage", catalog = "")
public class AppBizDzwl {
    private String owid;
    private String appOwid;
    private BigDecimal adressWd;
    private BigDecimal adressJd;
    ...
    @Basic
    @Column(name = "ADRESS_WD", nullable = true, precision = 7)
    public BigDecimal getAdressWd() {
        return adressWd;
    }

    public void setAdressWd(BigDecimal adressWd) {
        this.adressWd = adressWd;
    }

    @Basic
    @Column(name = "ADRESS_JD", nullable = true, precision = 7)
    public BigDecimal getAdressJd() {
        return adressJd;
    }

    public void setAdressJd(BigDecimal adressJd) {
        this.adressJd = adressJd;
    }
    ...
    @Basic
    @Column(name = "RANGES", nullable = true, precision = 0)
    ...
    public boolean equals(Object o) {
        ...
        if (adressWd != null ? !adressWd.equals(that.adressWd) : that.adressWd != null) return false;
        if (adressJd != null ? !adressJd.equals(that.adressJd) : that.adressJd != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (adressWd != null ? adressWd.hashCode() : 0);
        result = 31 * result + (adressJd != null ? adressJd.hashCode() : 0);
