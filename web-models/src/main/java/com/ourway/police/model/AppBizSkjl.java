 ...
 */
@Entity
@Table(name = "app_biz_skjl", schema = "public_manage", catalog = "")
public class AppBizSkjl {
    private String owid;
    private String appOwid;
    private String ickh;
    private String skrymc;
    private String skrylbmc;
    private String skrylbdm;
    private String skryzw;
    private String qymc;
    private Timestamp dtrq;
    private Timestamp sbsksj;
    private Byte sbskzt;
    private Timestamp xbsksj;
    private Byte xbskzt;
    private String exp1;
    private String exp2;
    private String exp3;
    ...
    @Basic
    @Column(name = "ICKH", nullable = true, length = 100)
    ...
    @Basic
    @Column(name = "SKRYMC", nullable = true, length = 50)
    public String getSkrymc() {
        return skrymc;
    }

    public void setSkrymc(String skrymc) {
        this.skrymc = skrymc;
    }

    @Basic
    @Column(name = "SKRYLBMC", nullable = true, length = 200)
    public String getSkrylbmc() {
        return skrylbmc;
    }

    public void setSkrylbmc(String skrylbmc) {
        this.skrylbmc = skrylbmc;
    }

    @Basic
    @Column(name = "SKRYLBDM", nullable = true, length = 64)
    public String getSkrylbdm() {
        return skrylbdm;
    }

    public void setSkrylbdm(String skrylbdm) {
        this.skrylbdm = skrylbdm;
    }

    @Basic
    @Column(name = "SKRYZW", nullable = true, length = 30)
    public String getSkryzw() {
        return skryzw;
    }

    public void setSkryzw(String skryzw) {
        this.skryzw = skryzw;
    }
    ...
    @Basic
    @Column(name = "DTRQ", nullable = true)
    public Timestamp getDtrq() {
        return dtrq;
    }

    public void setDtrq(Timestamp dtrq) {
        this.dtrq = dtrq;
    }

    @Basic
    @Column(name = "SBSKSJ", nullable = true)
    public Timestamp getSbsksj() {
        return sbsksj;
    }

    public void setSbsksj(Timestamp sbsksj) {
        this.sbsksj = sbsksj;
    }

    @Basic
    @Column(name = "SBSKZT", nullable = true)
    public Byte getSbskzt() {
        return sbskzt;
    }

    public void setSbskzt(Byte sbskzt) {
        this.sbskzt = sbskzt;
    }

    @Basic
    @Column(name = "XBSKSJ", nullable = true)
    public Timestamp getXbsksj() {
        return xbsksj;
    }

    public void setXbsksj(Timestamp xbsksj) {
        this.xbsksj = xbsksj;
    }

    @Basic
    @Column(name = "XBSKZT", nullable = true)
    public Byte getXbskzt() {
        return xbskzt;
    }

    public void setXbskzt(Byte xbskzt) {
        this.xbskzt = xbskzt;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (ickh != null ? !ickh.equals(that.ickh) : that.ickh != null) return false;
        if (skrymc != null ? !skrymc.equals(that.skrymc) : that.skrymc != null) return false;
        if (skrylbmc != null ? !skrylbmc.equals(that.skrylbmc) : that.skrylbmc != null) return false;
        if (skrylbdm != null ? !skrylbdm.equals(that.skrylbdm) : that.skrylbdm != null) return false;
        if (skryzw != null ? !skryzw.equals(that.skryzw) : that.skryzw != null) return false;
        if (qymc != null ? !qymc.equals(that.qymc) : that.qymc != null) return false;
        if (dtrq != null ? !dtrq.equals(that.dtrq) : that.dtrq != null) return false;
        if (sbsksj != null ? !sbsksj.equals(that.sbsksj) : that.sbsksj != null) return false;
        if (sbskzt != null ? !sbskzt.equals(that.sbskzt) : that.sbskzt != null) return false;
        if (xbsksj != null ? !xbsksj.equals(that.xbsksj) : that.xbsksj != null) return false;
        if (xbskzt != null ? !xbskzt.equals(that.xbskzt) : that.xbskzt != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (ickh != null ? ickh.hashCode() : 0);
        result = 31 * result + (skrymc != null ? skrymc.hashCode() : 0);
        result = 31 * result + (skrylbmc != null ? skrylbmc.hashCode() : 0);
        result = 31 * result + (skrylbdm != null ? skrylbdm.hashCode() : 0);
        result = 31 * result + (skryzw != null ? skryzw.hashCode() : 0);
        result = 31 * result + (qymc != null ? qymc.hashCode() : 0);
        result = 31 * result + (dtrq != null ? dtrq.hashCode() : 0);
        result = 31 * result + (sbsksj != null ? sbsksj.hashCode() : 0);
        result = 31 * result + (sbskzt != null ? sbskzt.hashCode() : 0);
        result = 31 * result + (xbsksj != null ? xbsksj.hashCode() : 0);
        result = 31 * result + (xbskzt != null ? xbskzt.hashCode() : 0);
