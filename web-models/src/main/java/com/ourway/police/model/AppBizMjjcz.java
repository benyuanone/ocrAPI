 ...
 */
@Entity
@Table(name = "app_biz_mjjcz", schema = "public_manage", catalog = "")
public class AppBizMjjcz {
    private String owid;
    ...
    @Basic
    @Column(name = "JGDM", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "MJJCZBH", nullable = true, length = 30)
    ...
    @Basic
    @Column(name = "JYH", nullable = true, length = 30)
    ...
    @Basic
    @Column(name = "JCZZT", nullable = true)
    public Byte getJczzt() {
        return jczzt;
    }

    public void setJczzt(Byte jczzt) {
        this.jczzt = jczzt;
    }

    @Basic
    @Column(name = "SLSJ", nullable = true)
    ...
    @Basic
    @Column(name = "ZWMC", nullable = true, length = 200)
    ...
    @Basic
    @Column(name = "ZJZMZ", nullable = true, length = 64)
    public String getZjzmz() {
        return zjzmz;
    }

    public void setZjzmz(String zjzmz) {
        this.zjzmz = zjzmz;
    }

    @Basic
    @Column(name = "ZJFMZ", nullable = true, length = 64)
    public String getZjfmz() {
        return zjfmz;
    }

    public void setZjfmz(String zjfmz) {
        this.zjfmz = zjfmz;
    }
    ...
    public boolean equals(Object o) {
        ...
        AppBizMjjcz that = (AppBizMjjcz) o;
        ...
        if (mjjczbh != null ? !mjjczbh.equals(that.mjjczbh) : that.mjjczbh != null) return false;
        if (jyh != null ? !jyh.equals(that.jyh) : that.jyh != null) return false;
        if (jczzt != null ? !jczzt.equals(that.jczzt) : that.jczzt != null) return false;
        ...
        if (zjzmz != null ? !zjzmz.equals(that.zjzmz) : that.zjzmz != null) return false;
        if (zjfmz != null ? !zjfmz.equals(that.zjfmz) : that.zjfmz != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (mjjczbh != null ? mjjczbh.hashCode() : 0);
        result = 31 * result + (jyh != null ? jyh.hashCode() : 0);
        result = 31 * result + (jczzt != null ? jczzt.hashCode() : 0);
        ...
        result = 31 * result + (zjzmz != null ? zjzmz.hashCode() : 0);
        result = 31 * result + (zjfmz != null ? zjfmz.hashCode() : 0);
