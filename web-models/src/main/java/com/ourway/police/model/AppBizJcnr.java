 ...
 */
@Entity
@Table(name = "app_biz_jcnr", schema = "public_manage", catalog = "")
public class AppBizJcnr {
    private String owid;
    private String appOwid;
    private String jcdxmc;
    private String jcdxdm;
    private String jcxxmc;
    private String jcxxdm;
    private Byte jcqk;
    private String czwt;
    private String exp1;
    private String exp2;
    ...
    @Basic
    @Column(name = "JCDXMC", nullable = true, length = 100)
    ...
    @Basic
    @Column(name = "JCDXDM", nullable = true, length = 64)
    public String getJcdxdm() {
        return jcdxdm;
    }

    public void setJcdxdm(String jcdxdm) {
        this.jcdxdm = jcdxdm;
    }

    @Basic
    @Column(name = "JCXXMC", nullable = true, length = 1000)
    public String getJcxxmc() {
        return jcxxmc;
    }

    public void setJcxxmc(String jcxxmc) {
        this.jcxxmc = jcxxmc;
    }

    @Basic
    @Column(name = "JCXXDM", nullable = true, length = 64)
    public String getJcxxdm() {
        return jcxxdm;
    }

    public void setJcxxdm(String jcxxdm) {
        this.jcxxdm = jcxxdm;
    }

    @Basic
    @Column(name = "JCQK", nullable = true)
    public Byte getJcqk() {
        return jcqk;
    }

    public void setJcqk(Byte jcqk) {
        this.jcqk = jcqk;
    }

    @Basic
    @Column(name = "CZWT", nullable = true, length = 1000)
    ...
    public boolean equals(Object o) {
        ...
        if (jcdxmc != null ? !jcdxmc.equals(that.jcdxmc) : that.jcdxmc != null) return false;
        if (jcdxdm != null ? !jcdxdm.equals(that.jcdxdm) : that.jcdxdm != null) return false;
        if (jcxxmc != null ? !jcxxmc.equals(that.jcxxmc) : that.jcxxmc != null) return false;
        if (jcxxdm != null ? !jcxxdm.equals(that.jcxxdm) : that.jcxxdm != null) return false;
        if (jcqk != null ? !jcqk.equals(that.jcqk) : that.jcqk != null) return false;
        if (czwt != null ? !czwt.equals(that.czwt) : that.czwt != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (jcdxmc != null ? jcdxmc.hashCode() : 0);
        result = 31 * result + (jcdxdm != null ? jcdxdm.hashCode() : 0);
        result = 31 * result + (jcxxmc != null ? jcxxmc.hashCode() : 0);
        result = 31 * result + (jcxxdm != null ? jcxxdm.hashCode() : 0);
        result = 31 * result + (jcqk != null ? jcqk.hashCode() : 0);
        result = 31 * result + (czwt != null ? czwt.hashCode() : 0);
