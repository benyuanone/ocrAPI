 ...
 */
@Entity
@Table(name = "app_biz_zzjg", schema = "public_manage", catalog = "")
public class AppBizZzjg {
    private int owid;
    private String jgdm;
    private String jgmc;
    private BigInteger jgcc;
    private String path;
    private Integer fjjg;
    private String jgqljbm;
    ...
    @Basic
    @Column(name = "JGMC", nullable = false, length = 100)
    ...
    @Basic
    @Column(name = "JGCC", nullable = true, precision = 0)
    public BigInteger getJgcc() {
        return jgcc;
    }

    public void setJgcc(BigInteger jgcc) {
        this.jgcc = jgcc;
    }
    ...
    @Basic
    @Column(name = "FJJG", nullable = true)
    public Integer getFjjg() {
        return fjjg;
    }

    public void setFjjg(Integer fjjg) {
        this.fjjg = fjjg;
    }

    @Basic
    @Column(name = "JGQLJBM", nullable = true, length = 200)
    public String getJgqljbm() {
        return jgqljbm;
    }

    public void setJgqljbm(String jgqljbm) {
        this.jgqljbm = jgqljbm;
    }

    @Basic
    @Column(name = "JDSX", nullable = true, precision = 0)
    public Integer getJdsx() {
        return jdsx;
    }

    public void setJdsx(Integer jdsx) {
        this.jdsx = jdsx;
    }

    @Basic
    @Column(name = "SFYJD", nullable = true)
    public Byte getSfyjd() {
        return sfyjd;
    }

    public void setSfyjd(Byte sfyjd) {
        this.sfyjd = sfyjd;
    }

    @Basic
    @Column(name = "JGJC", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "JGQC", nullable = true, length = 200)
    ...
    @Basic
    @Column(name = "JGBM", nullable = true, length = 20)
    ...
    public boolean equals(Object o) {
        ...
        AppBizZzjg that = (AppBizZzjg) o;

        if (owid != that.owid) return false;
        ...
        if (jgcc != null ? !jgcc.equals(that.jgcc) : that.jgcc != null) return false;
        if (path != null ? !path.equals(that.path) : that.path != null) return false;
        if (fjjg != null ? !fjjg.equals(that.fjjg) : that.fjjg != null) return false;
        if (jgqljbm != null ? !jgqljbm.equals(that.jgqljbm) : that.jgqljbm != null) return false;
        if (jdsx != null ? !jdsx.equals(that.jdsx) : that.jdsx != null) return false;
        if (sfyjd != null ? !sfyjd.equals(that.sfyjd) : that.sfyjd != null) return false;
        if (jgjc != null ? !jgjc.equals(that.jgjc) : that.jgjc != null) return false;
        if (jgqc != null ? !jgqc.equals(that.jgqc) : that.jgqc != null) return false;
        if (jgbm != null ? !jgbm.equals(that.jgbm) : that.jgbm != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (jgcc != null ? jgcc.hashCode() : 0);
        result = 31 * result + (path != null ? path.hashCode() : 0);
        result = 31 * result + (fjjg != null ? fjjg.hashCode() : 0);
        result = 31 * result + (jgqljbm != null ? jgqljbm.hashCode() : 0);
        result = 31 * result + (jdsx != null ? jdsx.hashCode() : 0);
        result = 31 * result + (sfyjd != null ? sfyjd.hashCode() : 0);
        result = 31 * result + (jgjc != null ? jgjc.hashCode() : 0);
