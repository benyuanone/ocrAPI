 ...
 */
@Entity
@Table(name = "app_biz_xctb", schema = "public_manage", catalog = "")
public class AppBizXctb {
    private String owid;
    private String bt;
    ...
    @Basic
    @Column(name = "BT", nullable = true, length = 100)
    public String getBt() {
        return bt;
    }
    ...
    @Basic
    @Column(name = "FBNR", nullable = true, length = 4000)
    ...
    @Basic
    @Column(name = "FBR", nullable = true, length = 100)
    ...
    @Basic
    @Column(name = "FBDWBM", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "GQBS", nullable = true, length = 2)
    ...
    @Basic
    @Column(name = "SXHYLBDM", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "SXHYLBMC", nullable = true, length = 200)
    ...
    @Basic
    @Column(name = "YTBID", nullable = true, precision = 0)
    ...
    public boolean equals(Object o) {
        ...
        if (fbnr != null ? !fbnr.equals(that.fbnr) : that.fbnr != null) return false;
        if (fbr != null ? !fbr.equals(that.fbr) : that.fbr != null) return false;
        if (fbdwbm != null ? !fbdwbm.equals(that.fbdwbm) : that.fbdwbm != null) return false;
        if (fbdw != null ? !fbdw.equals(that.fbdw) : that.fbdw != null) return false;
        if (jzrq != null ? !jzrq.equals(that.jzrq) : that.jzrq != null) return false;
        if (gqbs != null ? !gqbs.equals(that.gqbs) : that.gqbs != null) return false;
        if (sxhylbdm != null ? !sxhylbdm.equals(that.sxhylbdm) : that.sxhylbdm != null) return false;
        if (sxhylbmc != null ? !sxhylbmc.equals(that.sxhylbmc) : that.sxhylbmc != null) return false;
        if (ytbid != null ? !ytbid.equals(that.ytbid) : that.ytbid != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (fbnr != null ? fbnr.hashCode() : 0);
        result = 31 * result + (fbr != null ? fbr.hashCode() : 0);
        result = 31 * result + (fbdwbm != null ? fbdwbm.hashCode() : 0);
        result = 31 * result + (fbdw != null ? fbdw.hashCode() : 0);
        result = 31 * result + (jzrq != null ? jzrq.hashCode() : 0);
        result = 31 * result + (gqbs != null ? gqbs.hashCode() : 0);
        result = 31 * result + (sxhylbdm != null ? sxhylbdm.hashCode() : 0);
        result = 31 * result + (sxhylbmc != null ? sxhylbmc.hashCode() : 0);
        result = 31 * result + (ytbid != null ? ytbid.hashCode() : 0);
