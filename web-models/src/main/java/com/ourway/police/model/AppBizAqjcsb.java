 ...
 */
@Entity
@Table(name = "app_biz_aqjcsb", schema = "public_manage", catalog = "")
public class AppBizAqjcsb {
    private String owid;
    ...
    @Basic
    @Column(name = "AQJCSBZLBM", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "AQJCSBZLMC", nullable = true, length = 100)
    ...
    public boolean equals(Object o) {
        ...
        AppBizAqjcsb that = (AppBizAqjcsb) o;
        ...
        if (aqjcsbzlbm != null ? !aqjcsbzlbm.equals(that.aqjcsbzlbm) : that.aqjcsbzlbm != null) return false;
        if (aqjcsbzlmc != null ? !aqjcsbzlmc.equals(that.aqjcsbzlmc) : that.aqjcsbzlmc != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (aqjcsbzlbm != null ? aqjcsbzlbm.hashCode() : 0);
        result = 31 * result + (aqjcsbzlmc != null ? aqjcsbzlmc.hashCode() : 0);
