 ...
 */
@Entity
@Table(name = "app_biz_wgcyryxx", schema = "public_manage", catalog = "")
public class AppBizWgcyryxx {
    private String owid;
    ...
    @Basic
    @Column(name = "YWX", nullable = true, length = 60)
    ...
    @Basic
    @Column(name = "YWM", nullable = true, length = 60)
    ...
    @Basic
    @Column(name = "WGRJYXKZ", nullable = true, length = 60)
    ...
    @Basic
    @Column(name = "QZZLDM", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "QZHM", nullable = true, length = 20)
    ...
    @Basic
    @Column(name = "ZATLQ", nullable = true)
    public Timestamp getZatlq() {
        return zatlq;
    }

    public void setZatlq(Timestamp zatlq) {
        this.zatlq = zatlq;
    }

    @Basic
    @Column(name = "QFJG", nullable = true, length = 120)
    ...
    @Basic
    @Column(name = "RJRQ", nullable = true)
    ...
    @Basic
    @Column(name = "RJKA", nullable = true, length = 60)
    ...
    public boolean equals(Object o) {
        ...
        AppBizWgcyryxx that = (AppBizWgcyryxx) o;
        ...
        if (wgrjyxkz != null ? !wgrjyxkz.equals(that.wgrjyxkz) : that.wgrjyxkz != null) return false;
        if (qzzldm != null ? !qzzldm.equals(that.qzzldm) : that.qzzldm != null) return false;
        if (qzhm != null ? !qzhm.equals(that.qzhm) : that.qzhm != null) return false;
        if (zatlq != null ? !zatlq.equals(that.zatlq) : that.zatlq != null) return false;
        if (qfjg != null ? !qfjg.equals(that.qfjg) : that.qfjg != null) return false;
        if (rjrq != null ? !rjrq.equals(that.rjrq) : that.rjrq != null) return false;
        if (rjka != null ? !rjka.equals(that.rjka) : that.rjka != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (wgrjyxkz != null ? wgrjyxkz.hashCode() : 0);
        result = 31 * result + (qzzldm != null ? qzzldm.hashCode() : 0);
        result = 31 * result + (qzhm != null ? qzhm.hashCode() : 0);
        result = 31 * result + (zatlq != null ? zatlq.hashCode() : 0);
        result = 31 * result + (qfjg != null ? qfjg.hashCode() : 0);
        result = 31 * result + (rjrq != null ? rjrq.hashCode() : 0);
        result = 31 * result + (rjka != null ? rjka.hashCode() : 0);
