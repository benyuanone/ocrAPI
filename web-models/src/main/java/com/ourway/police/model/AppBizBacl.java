 ...
 */
@Entity
@Table(name = "app_biz_bacl", schema = "public_manage", catalog = "")
public class AppBizBacl {
    private String owid;
    ...
    @Basic
    @Column(name = "DXMC", nullable = true, length = 200)
    ...
    @Basic
    @Column(name = "DXDM", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "XXMC", nullable = true, length = 200)
    ...
    @Basic
    @Column(name = "XXDM", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "TJZT", nullable = true)
    public Byte getTjzt() {
        return tjzt;
    }

    public void setTjzt(Byte tjzt) {
        this.tjzt = tjzt;
    }

    @Basic
    @Column(name = "TPLJ", nullable = true, length = 64)
    ...
    public Timestamp getTjrq() {
        return tjrq;
    }

    public void setTjrq(Timestamp tjrq) {
        this.tjrq = tjrq;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (dxdm != null ? !dxdm.equals(that.dxdm) : that.dxdm != null) return false;
        if (xxmc != null ? !xxmc.equals(that.xxmc) : that.xxmc != null) return false;
        if (xxdm != null ? !xxdm.equals(that.xxdm) : that.xxdm != null) return false;
        if (tjzt != null ? !tjzt.equals(that.tjzt) : that.tjzt != null) return false;
        if (tplj != null ? !tplj.equals(that.tplj) : that.tplj != null) return false;
        if (tjr != null ? !tjr.equals(that.tjr) : that.tjr != null) return false;
        if (tjrq != null ? !tjrq.equals(that.tjrq) : that.tjrq != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (dxdm != null ? dxdm.hashCode() : 0);
        result = 31 * result + (xxmc != null ? xxmc.hashCode() : 0);
        result = 31 * result + (xxdm != null ? xxdm.hashCode() : 0);
        result = 31 * result + (tjzt != null ? tjzt.hashCode() : 0);
        result = 31 * result + (tplj != null ? tplj.hashCode() : 0);
        result = 31 * result + (tjr != null ? tjr.hashCode() : 0);
        result = 31 * result + (tjrq != null ? tjrq.hashCode() : 0);
