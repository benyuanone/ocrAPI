 ...
 */
@Entity
@Table(name = "app_biz_tpxx", schema = "public_manage", catalog = "")
public class AppBizTpxx {
    private String owid;
    private String tpmc;
    private String tpdm;
    private String tplj;
    ...
    @Basic
    @Column(name = "TPMC", nullable = true, length = 100)
    ...
    @Basic
    @Column(name = "TPDM", nullable = true, length = 64)
    public String getTpdm() {
        return tpdm;
    }

    public void setTpdm(String tpdm) {
        this.tpdm = tpdm;
    }

    @Basic
    @Column(name = "TPLJ", nullable = true, length = 200)
    ...
    public boolean equals(Object o) {
        ...
        AppBizTpxx that = (AppBizTpxx) o;

        if (owid != null ? !owid.equals(that.owid) : that.owid != null) return false;
        if (tpmc != null ? !tpmc.equals(that.tpmc) : that.tpmc != null) return false;
        if (tpdm != null ? !tpdm.equals(that.tpdm) : that.tpdm != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (tpmc != null ? tpmc.hashCode() : 0);
        result = 31 * result + (tpdm != null ? tpdm.hashCode() : 0);
